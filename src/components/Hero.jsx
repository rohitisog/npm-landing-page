...
const Hero = () => {
  return (
    <div className="hero bg-cover bg-center px-6 text-center h-full flex flex-col items-center justify-center">
      ...
      <div className="py-15 flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mt-6">
        <button className="font-bold w-full md:w-auto bg-yellow-400 px-10 py-4 md:px-14 rounded-full shadow-2xl shadow-black">
          Sign up for free
        </button>
        <button className="font-semibold w-full md:w-auto px-8 py-4 md:px-14 rounded-full bg-gradient-to-r from-red-500 to-red-800 text-white border-2">
          Learn about Pro
        </button>
      </div>
    </div>
